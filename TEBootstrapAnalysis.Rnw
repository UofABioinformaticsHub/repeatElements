...
vapply(bootSingleAlu, function(x){x$samples}, numeric(1000)) %>%
...
vapply(bootSingleL1, function(x){x$samples}, numeric(1000)) %>%
  melt(varnames = c("Row", "Tissue"), value.name = "TPM") %>%
  mutate(Tissue = gsub("_TPM", "", Tissue),
         Tissue = capwords(Tissue)) %>%
  ggplot(aes(x = TPM, fill = Tissue)) +
...
vapply(bootSingleL2, function(x){x$samples}, numeric(1000)) %>%
  melt(varnames = c("Row", "Tissue"), value.name = "TPM") %>%
  mutate(Tissue = gsub("_TPM", "", Tissue),
         Tissue = capwords(Tissue)) %>%
  ggplot(aes(x = TPM, fill = Tissue)) +
...
vapply(bootSingleLTR, function(x){x$samples}, numeric(1000)) %>%
  melt(varnames = c("Row", "Tissue"), value.name = "TPM") %>%
  mutate(Tissue = gsub("_TPM", "", Tissue),
         Tissue = capwords(Tissue)) %>%
  ggplot(aes(x = TPM, fill = Tissue)) +
...
vapply(bootSingleMir, function(x){x$samples}, numeric(1000)) %>%
  melt(varnames = c("Row", "Tissue"), value.name = "TPM") %>%
  mutate(Tissue = gsub("_TPM", "", Tissue),
         Tissue = capwords(Tissue)) %>%
  ggplot(aes(x = TPM, fill = Tissue)) +
...
vapply(bootAluPlusOne, function(x){x$samples}, numeric(1000)) %>%
  melt(varnames = c("Row", "Tissue"), value.name = "TPM") %>%
  mutate(Tissue = gsub("_TPM", "", Tissue),
         Tissue = capwords(Tissue)) %>%
  ggplot(aes(x = TPM, fill = Tissue)) +
...
vapply(bootL1PlusOne, function(x){x$samples}, numeric(1000)) %>%
  melt(varnames = c("Row", "Tissue"), value.name = "TPM") %>%
  mutate(Tissue = gsub("_TPM", "", Tissue),
         Tissue = capwords(Tissue)) %>%
  ggplot(aes(x = TPM, fill = Tissue)) +
...
vapply(bootL2PlusOne, function(x){x$samples}, numeric(1000)) %>%
  melt(varnames = c("Row", "Tissue"), value.name = "TPM") %>%
  mutate(Tissue = gsub("_TPM", "", Tissue),
         Tissue = capwords(Tissue)) %>%
  ggplot(aes(x = TPM, fill = Tissue)) +
...
vapply(bootLTRPlusOne, function(x){x$samples}, numeric(1000)) %>%
  melt(varnames = c("Row", "Tissue"), value.name = "TPM") %>%
  mutate(Tissue = gsub("_TPM", "", Tissue),
         Tissue = capwords(Tissue)) %>%
  ggplot(aes(x = TPM, fill = Tissue)) +
...
<<plotMirPlusOne, echo=FALSE, fig.height= 4, fig.cap = "Bootstrapped differences in mean log(TPM) for genes with L1 elements in isolation when compared to genes with no TEs.">>=
vapply(bootMirPlusOne, function(x){x$samples}, numeric(1000)) %>%
  melt(varnames = c("Row", "Tissue"), value.name = "TPM") %>%
  mutate(Tissue = gsub("_TPM", "", Tissue),
         Tissue = capwords(Tissue)) %>%
  ggplot(aes(x = TPM, fill = Tissue)) +
